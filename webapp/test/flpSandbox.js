					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Ordem de Vendas",
									"targetURL": "#zped-display"
								}
							}]
						}]
					}
					...
					"config": {
						"inbounds": {
							"zped-display": {
								"semanticObject": "zped",
								"action": "display",
								"description": "App Ordem de Vendas",
								"title": "App Ordem de Vendas",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=zped",
									"url": sap.ui.require.toUrl("zped")
								}
							}
						}
					}
